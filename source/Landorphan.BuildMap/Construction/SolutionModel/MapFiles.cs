namespace Landorphan.BuildMap.Construction.SolutionModel
{
    ...
    public class MapFiles
    {
        ...
        public Guid ComputeId(byte[] rawData)
        {
            ...
            var retval = new Guid(hash.Take(16).ToArray());
            return retval;
        }
        ...
        public SuppliedFile DetermineFileType(SuppliedFile suppliedFile)
        {
            ...
            {
                var suppliedSolutionFile = new SuppliedSolutionFile(suppliedFile);
                ...
                try
                {
                    var sln = AbstractionManager.ParseSolutionFile(suppliedFile);
            ...
            var suppliedProjectFile = LoadProjectFileContents(suppliedFile);
        ...
        {
            return ProjectFiles.Values.ToList();
        }

        public List<SuppliedSolutionFile> GetAllSolutionFiles()
        {
            return SolutionFiles.Values.ToList();
        }
        ...
        {
            suppliedFile.ArgumentNotNull(nameof(suppliedFile));
            var retval = new SuppliedProjectFile(suppliedFile);
