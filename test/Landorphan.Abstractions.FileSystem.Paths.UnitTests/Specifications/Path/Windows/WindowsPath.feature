...
| Null                 | (null)                            | 1      | {N} (null)  | {N} (null)      | {N} (null)   | {N} (null)   | {N} (null) | {N} (null)  | {N} (null)  | Relative | Illegal     | 0          |
# an empty string can be parsed but will produce an empty path (which is an illegal path)										  												
| Empty                | (empty)                           | 1      | {E} (empty) | {N} (null)      | {N} (null)   | {N} (null)   | {N} (null) | {N} (null)  | {N} (null)  | Relative | Illegal     | 0          |
