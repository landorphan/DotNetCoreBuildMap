...
Examples: 
| Name               | Path                              | Length | Root        | Segment 1       | Segment 2    | Segment 3    | Segment 4  | Segment 5  | Segment 6  | Anchor   | Status      | Norm Level |
# a null string can be parsed but will produce a null path (which is an illegal path)																										
| Null               | (null)                            | 1      | {N} (null)  | {N} (null)      | {N} (null)   | {N} (null)   | {N} (null) | {N} (null) | {N} (null) | Absolute | Illegal     | 1          |
# an empty string can be parsed but will produce an empty path (which is an illegal path)										  															
| Empty              | (empty)                           | 1      | {E} (empty) | {N} (null)      | {N} (null)   | {N} (null)   | {N} (null) | {N} (null) | {N} (null) | Absolute | Illegal     | 1          |
...
| Rel CON            | ..`.`CON                          | 3      | {..} ..     | {.} .           | {D} CON      | {N} (null)   | {N} (null) | {N} (null) | {N} (null) | Absolute | Legal       | -1         |
# Using a device path as an absolute path is actually legal (all device paths are absolute)										  															
| Abs Con            | C:`CON                            | 2      | {R} C:      | {D} CON         | {N} (null)   | {N} (null)   | {N} (null) | {N} (null) | {N} (null) | Absolute | Legal       | 1          |
...
| Illegal Rel Colon  | .`foo:bar.txt                     | 2      | {.} .       | {G} foo:bar.txt | {N} (null)   | {N} (null)   | {N} (null) | {N} (null) | {N} (null) | Relative | Illegal     | 1          |
