...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Specifications/Path/Windows", "Windows Path Simplification", "\tIn order to develop a reliable Windows Path parser \r\n\tAs a member of the Landorp" +
        ...
        [NUnit.Framework.DescriptionAttribute("Windows Paths can be simplified to best available form.")]
        [NUnit.Framework.TestCaseAttribute("(null)", "Legal", "Relative", "false", "{E} (empty)", ".", "SelfReferenceOnly", "Imposible for Null path to simplify", null)]
        [NUnit.Framework.TestCaseAttribute("(empty)", "Legal", "Relative", "false", "{E} (empty)", ".", "SelfReferenceOnly", "Imposible for Empty path to simplify", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("/", "Legal", "Absolute", "false", "{$}", "`", "Fully", "A root only segment should be created and this path is simplified", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("foo/bar", "Legal", "Relative", "false", "{E} (empty)", "foo`bar", "Fully", "This path is relative but fully simplified", null)]
        [NUnit.Framework.TestCaseAttribute("foo/../bar", "Legal", "Relative", "false", "{E} (empty)", "bar", "Fully", "This path is not normal because of the parent segment but can be fully simplified" +
            "", null)]
        [NUnit.Framework.TestCaseAttribute("../foo/bar", "Legal", "Relative", "false", "{E} (empty)", "..`foo`bar", "LeadingParentsOnly", "This path is as simplified as it can be ... leading parent segements can\'t be rem" +
            "oved", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir/file.txt", "Legal", "Absolute", "true", "{R} C", "C:`dir`file.txt", "Fully", "This path is fully simplified", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir/file.txt/", "Legal", "Absolute", "true", "{R} C", "C:`dir`file.txt", "Fully", "The trailing slash adds an empty segement thus it\'s not simplified", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir", "Legal", "Absolute", "true", "{R} C", "C:`dir", "Fully", "This path is fully simplified", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir/", "Legal", "Absolute", "true", "{R} C", "C:`dir", "Fully", "The trailing slash adds an empty segement thus it\'s not simplified", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("C:./file.txt/", "Legal", "Relative", "true", "{E} (empty)", "C:file.txt", "Fully", "This is a Windows path so the \'.\' is a self reference (and is removed).  The resu" +
            "lt is Vol Rel", null)]
        [NUnit.Framework.TestCaseAttribute("C:file.txt", "Legal", "Relative", "true", "{E} (empty)", "C:file.txt", "Fully", "While not relative this path is still simplified", null)]
        [NUnit.Framework.TestCaseAttribute("C:file.txt/", "Legal", "Relative", "true", "{E} (empty)", "C:file.txt", "Fully", "Trailing Slash prevents simplification", null)]
        [NUnit.Framework.TestCaseAttribute("C:dir", "Legal", "Relative", "true", "{E} (empty)", "C:dir", "Fully", "Fully simplified", null)]
        [NUnit.Framework.TestCaseAttribute("C:dir/", "Legal", "Relative", "true", "{E} (empty)", "C:dir", "Fully", "Trailing slash prevents simplification", null)]
        [NUnit.Framework.TestCaseAttribute("C:dir/file.txt", "Legal", "Relative", "true", "{E} (empty)", "C:dir`file.txt", "Fully", "Fully simplified", null)]
        [NUnit.Framework.TestCaseAttribute("C:dir/file.txt/", "Legal", "Relative", "true", "{E} (empty)", "C:dir`file.txt", "Fully", "Trailing Slash", null)]
        [NUnit.Framework.TestCaseAttribute("//server/share", "Legal", "Absolute", "true", "{X} server", "``server`share", "Fully", "Fully simplified remote path", null)]
        [NUnit.Framework.TestCaseAttribute("//server/share/", "Legal", "Absolute", "true", "{X} server", "``server`share", "Fully", "Trailing Slash", null)]
        [NUnit.Framework.TestCaseAttribute("//server/file.txt", "Legal", "Absolute", "true", "{X} server", "``server`file.txt", "Fully", "Fully simplified remote path", null)]
        [NUnit.Framework.TestCaseAttribute("//server/file.txt/", "Legal", "Absolute", "true", "{X} server", "``server`file.txt", "Fully", "Trailing Slash", null)]
        [NUnit.Framework.TestCaseAttribute("//server/share/dir/file.txt", "Legal", "Absolute", "true", "{X} server", "``server`share`dir`file.txt", "Fully", "Fully simplified remote path", null)]
        ...
        [NUnit.Framework.TestCaseAttribute(".", "Legal", "Relative", "false", "{E} (empty)", ".", "SelfReferenceOnly", "This is simplified as best as posilbe, its a special case where the path only has" +
        ...
        [NUnit.Framework.TestCaseAttribute("..", "Legal", "Relative", "false", "{E} (empty)", "..", "LeadingParentsOnly", "Only has a leading parent ... best posible simplification", null)]
        [NUnit.Framework.TestCaseAttribute("../", "Legal", "Relative", "false", "{E} (empty)", "..", "LeadingParentsOnly", "Trailing slash", null)]
        [NUnit.Framework.TestCaseAttribute("../dir/file.txt", "Legal", "Relative", "false", "{E} (empty)", "..`dir`file.txt", "LeadingParentsOnly", "Only has leading parents ... best posible simplification", null)]
        ...
        [NUnit.Framework.TestCaseAttribute(".//.//.//.", "Legal", "Relative", "false", "{E} (empty)", ".", "SelfReferenceOnly", "Same as above as empty segments count as self references for simplification purpo" +
            "ses", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("``server`..`..", "Legal", "Absolute", "true", "{X} server", "``server", "Fully", "Parrent trversal stops at the first \"rooted\" segment", null)]
        public virtual void WindowsPathsCanBeSimplifiedToBestAvailableForm_(string path, string pathStatus, string anchor, string fullyQualified, string rootSegment, string simplifiedPath, string simplificationLevel, string notes, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("simplified Path", simplifiedPath);
            argumentsOfScenario.Add("Simplification Level", simplificationLevel);
            argumentsOfScenario.Add("Notes", notes);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Windows Paths can be simplified to best available form.", null, tagsOfScenario, argumentsOfScenario);
#line 7
...
#line hidden
#line 16
  testRunner.Then(string.Format("the resulting path should read: {0}", simplifiedPath), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 17
