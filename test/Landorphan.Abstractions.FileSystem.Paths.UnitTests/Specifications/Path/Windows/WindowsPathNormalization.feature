...
| /                            | Legal       | Absolute | false           | {/}          | `                           | Fully               | A root only segment should be created and this path is normalized                                  |
...
| C:/dir/file.txt              | Legal       | Absolute | true            | {R} C        | C:`dir`file.txt             | Fully               | This path is fully normalized                                                                      |
| C:/dir/file.txt/             | Legal       | Absolute | true            | {R} C        | C:`dir`file.txt             | Fully               | The trailing slash adds an empty segement thus it's not normalized                                 |
| C:/dir                       | Legal       | Absolute | true            | {R} C        | C:`dir                      | Fully               | This path is fully normalized                                                                      |
| C:/dir/                      | Legal       | Absolute | true            | {R} C        | C:`dir                      | Fully               | The trailing slash adds an empty segement thus it's not normalized                                 |
...
| C:./file.txt/                | Legal       | Relative | true            | {E} (empty)  | C:file.txt                  | Fully               | This is a Windows path so the '.' is a self reference (and is removed).  The result is Vol Rel     |
| C:file.txt                   | Legal       | Relative | true            | {E} (empty)  | C:file.txt                  | Fully               | While not relative this path is still normalized                                                   |
| C:file.txt/                  | Legal       | Relative | true            | {E} (empty)  | C:file.txt                  | Fully               | Trailing Slash prevents normalization                                                              |
| C:dir                        | Legal       | Relative | true            | {E} (empty)  | C:dir                       | Fully               | Fully normalized                                                                                   |
| C:dir/                       | Legal       | Relative | true            | {E} (empty)  | C:dir                       | Fully               | Trailing slash prevents normalziaiton                                                              |
| C:dir/file.txt               | Legal       | Relative | true            | {E} (empty)  | C:dir`file.txt              | Fully               | Fully normalized                                                                                   |
| C:dir/file.txt/              | Legal       | Relative | true            | {E} (empty)  | C:dir`file.txt              | Fully               | Trailing Slash                                                                                     |
| //server/share               | Legal       | Absolute | true            | {U} server   | ``server`share              | Fully               | Fully normalized remote path                                                                       |
| //server/share/              | Legal       | Absolute | true            | {U} server   | ``server`share              | Fully               | Trailing Slash                                                                                     |
| //server/file.txt            | Legal       | Absolute | true            | {U} server   | ``server`file.txt           | Fully               | Fully normalized remote path                                                                       |
| //server/file.txt/           | Legal       | Absolute | true            | {U} server   | ``server`file.txt           | Fully               | Trailing Slash                                                                                     |
| //server/share/dir/file.txt  | Legal       | Absolute | true            | {U} server   | ``server`share`dir`file.txt | Fully               | Fully normalized remote path                                                                       |
| //server/share/dir/file.txt/ | Legal       | Absolute | true            | {U} server   | ``server`share`dir`file.txt | Fully               | Trailing Slash                                                                                     |
...
| /../..                       | Legal       | Absolute | false           | {/}          | `                           | Fully               | Parrent trversal stops at the first "rooted" segment                                               |
| ``server`..                  | Legal       | Absolute | true            | {U} server   | ``server                    | Fully               | Parrent trversal stops at the first "rooted" segment                                               |
| ``server`..`..               | Legal       | Absolute | true            | {U} server   | ``server                    | Fully               | Parrent trversal stops at the first "rooted" segment                                               |
