...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("`dir`file.txt`", "{E} (empty)", "{/} dir", "{G} file.txt", "{E} (empty)", "{N} (null)", "{N} (null)", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("`dir`CON", "{E} (empty)", "{/} dir", "{D} CON", "{N} (null)", "{N} (null)", "{N} (null)", null)]
