...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("/dir/file.txt/", "{R}", "{G} dir", "{G} file.txt", "{E} (empty)", "{N} (null)", "{N} (null)", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("/dir/CON", "{R}", "{G} dir", "{G} CON", "{N} (null)", "{N} (null)", "{N} (null)", null)]
