...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Specifications/Path/Posix", "Posix Path Segments", "\tIn order to develop a reliable Windows Path parser \r\n\tAs a member of the Landorp" +
        ...
        [NUnit.Framework.TestCaseAttribute("C:/", "{G} C:", "{E} (empty)", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir/file.txt", "{G} C:", "{G} dir", "{G} file.txt", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir/file.txt/", "{G} C:", "{G} dir", "{G} file.txt", "{E} (empty)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir", "{G} C:", "{G} dir", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir/", "{G} C:", "{G} dir", "{E} (empty)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:/dir//file.txt", "{G} C:", "{G} dir", "{E} (empty)", "{G} file.txt", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:./file.txt", "{G} C:.", "{G} file.txt", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:./file.txt/", "{G} C:.", "{G} file.txt", "{E} (empty)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:file.txt", "{G} C:file.txt", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:file.txt/", "{G} C:file.txt", "{E} (empty)", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:dir", "{G} C:dir", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:dir/", "{G} C:dir", "{E} (empty)", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:dir/file.txt", "{G} C:dir", "{G} file.txt", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:dir/file.txt/", "{G} C:dir", "{G} file.txt", "{E} (empty)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("//?/C:/dir/file.txt", "{X} ?", "{G} C:", "{G} dir", "{G} file.txt", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("//?/C:/dir/file.txt/", "{X} ?", "{G} C:", "{G} dir", "{G} file.txt", "{E} (empty)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("//?/UNC/server/share/dir/file.txt", "{X} ?", "{G} UNC", "{G} server", "{G} share", "{G} dir", "{G} file.txt", null)]
        [NUnit.Framework.TestCaseAttribute("//?/UNC/server//file.txt/", "{X} ?", "{G} UNC", "{G} server", "{E} (empty)", "{G} file.txt", "{E} (empty)", null)]
        [NUnit.Framework.TestCaseAttribute("/dir/file.txt/", "{R}", "{G} dir", "{G} file.txt", "{E} (empty)", "{0} (null)", "{0} (null)", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("CON", "{G} CON", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("C:/CON", "{G} C:", "{G} CON", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("../CON", "{P} ..", "{G} CON", "{0} (null)", "{0} (null)", "{0} (null)", "{0} (null)", null)]
        [NUnit.Framework.TestCaseAttribute("/dir/CON", "{R}", "{G} dir", "{G} CON", "{0} (null)", "{0} (null)", "{0} (null)", null)]
