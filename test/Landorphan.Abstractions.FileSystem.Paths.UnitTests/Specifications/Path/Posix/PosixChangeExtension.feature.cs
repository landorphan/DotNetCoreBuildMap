...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("/foo.txt", ".json.txt.", "/foo.json.txt.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/foo.txt", "..", "/foo..", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/foo.txt", ".json.", "/foo.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/foo.txt", "json.", "/foo.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/foo.txt", "json%20", "/foo.json%20", "Discouraged", "true", ".json%20", "Trailing \' \' are discouraged on Posix (but not illegal)", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("/foo.bar.txt", ".json.txt.", "/foo.bar.json.txt.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/foo.bar.txt", "..", "/foo.bar..", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/foo.bar.txt", ".json.", "/foo.bar.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/foo.bar.txt", "json.", "/foo.bar.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/foo.bar.txt", "json%20", "/foo.bar.json%20", "Discouraged", "true", ".json%20", "Trailing \' \' are discouraged on Posix (but not illegal)", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("/.gitignore", ".json.txt.", "/.gitignore.json.txt.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/.gitignore", "..", "/.gitignore..", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/.gitignore", ".json.", "/.gitignore.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/.gitignore", "json.", "/.gitignore.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/.gitignore", "json%20", "/.gitignore.json%20", "Discouraged", "true", ".json%20", "Trailing \' \' are discouraged on Posix (but not illegal)", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("/.gitignore.txt", ".json.txt.", "/.gitignore.json.txt.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/.gitignore.txt", "..", "/.gitignore..", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/.gitignore.txt", ".json.", "/.gitignore.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/.gitignore.txt", "json.", "/.gitignore.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/.gitignore.txt", "json%20", "/.gitignore.json%20", "Discouraged", "true", ".json%20", "Trailing \' \' are discouraged on Posix (but not illegal)", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("/file", ".json.txt.", "/file.json.txt.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/file", "..", "/file..", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/file", ".json.", "/file.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/file", "json.", "/file.json.", "Discouraged", "true", "(empty)", "Trailing \'.\' are discouraged on Posix (but not illegal)", null)]
        [NUnit.Framework.TestCaseAttribute("/file", "json%20", "/file.json%20", "Discouraged", "true", ".json%20", "Trailing \' \' are discouraged on Posix (but not illegal)", null)]
