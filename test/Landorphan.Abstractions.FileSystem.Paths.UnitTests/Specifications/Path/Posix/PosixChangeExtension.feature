...
| /foo.txt        | .json.txt.    | /foo.json.txt.        | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.txt        | ..            | /foo..                | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.txt        | .json.        | /foo.json.            | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.txt        | json.         | /foo.json.            | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.txt        | json%20       | /foo.json%20          | Legal           | true           | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
...
| /foo.bar.txt    | .json.txt.    | /foo.bar.json.txt.    | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.bar.txt    | ..            | /foo.bar..            | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.bar.txt    | .json.        | /foo.bar.json.        | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.bar.txt    | json.         | /foo.bar.json.        | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.bar.txt    | json%20       | /foo.bar.json%20      | Legal           | true           | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
...
| /.gitignore     | .json.txt.    | /.gitignore.json.txt. | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore     | ..            | /.gitignore..         | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore     | .json.        | /.gitignore.json.     | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore     | json.         | /.gitignore.json.     | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore     | json%20       | /.gitignore.json%20   | Legal           | true           | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
...
| /.gitignore.txt | .json.txt.    | /.gitignore.json.txt. | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore.txt | ..            | /.gitignore..         | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore.txt | .json.        | /.gitignore.json.     | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore.txt | json.         | /.gitignore.json.     | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore.txt | json%20       | /.gitignore.json%20   | Legal           | true           | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
...
| /file           | .json.txt.    | /file.json.txt.       | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /file           | ..            | /file..               | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /file           | .json.        | /file.json.           | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /file           | json.         | /file.json.           | Legal           | true           | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /file           | json%20       | /file.json%20         | Legal           | true           | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
