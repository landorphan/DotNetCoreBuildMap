...
| /foo.txt        | .json.txt.    | /foo.json.txt.        | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.txt        | ..            | /foo..                | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.txt        | .json.        | /foo.json.            | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.txt        | json.         | /foo.json.            | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.txt        | json%20       | /foo.json%20          | Discouraged     | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
...
| /foo.bar.txt    | .json.txt.    | /foo.bar.json.txt.    | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.bar.txt    | ..            | /foo.bar..            | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.bar.txt    | .json.        | /foo.bar.json.        | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.bar.txt    | json.         | /foo.bar.json.        | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /foo.bar.txt    | json%20       | /foo.bar.json%20      | Discouraged     | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
...
| /.gitignore     | .json.txt.    | /.gitignore.json.txt. | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore     | ..            | /.gitignore..         | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore     | .json.        | /.gitignore.json.     | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore     | json.         | /.gitignore.json.     | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore     | json%20       | /.gitignore.json%20   | Discouraged     | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
...
| /.gitignore.txt | .json.txt.    | /.gitignore.json.txt. | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore.txt | ..            | /.gitignore..         | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore.txt | .json.        | /.gitignore.json.     | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore.txt | json.         | /.gitignore.json.     | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /.gitignore.txt | json%20       | /.gitignore.json%20   | Discouraged     | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
...
| /file           | .json.txt.    | /file.json.txt.       | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /file           | ..            | /file..               | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /file           | .json.        | /file.json.           | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /file           | json.         | /file.json.           | Discouraged     | (empty)             | Trailing '.' are discouraged on Posix (but not illegal) |
| /file           | json%20       | /file.json%20         | Discouraged     | .json%20            | Trailing ' ' are discouraged on Posix (but not illegal) |
