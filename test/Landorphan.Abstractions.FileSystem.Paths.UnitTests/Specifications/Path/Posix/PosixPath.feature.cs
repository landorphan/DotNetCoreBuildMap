...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Root Pos Back", "/a/b/../c/../e", "7", "{R}", "{G} a", "{G} b", "{..} ..", "{G} c", "{..} ..", "{G} e", "Absolute", "Legal", "2", null)]
        [NUnit.Framework.TestCaseAttribute("Root Neg Back", "/a/b/../../../e", "7", "{R}", "{G} a", "{G} b", "{..} ..", "{..} ..", "{..} ..", "{G} e", "Absolute", "Legal", "-1", null)]
        [NUnit.Framework.TestCaseAttribute("Root Neg Back 2", "/a/../../e/", "6", "{R}", "{G} a", "{..} ..", "{..} ..", "{G} e", "{E} (empty)", "{N} (null)", "Absolute", "Legal", "-1", null)]
        public virtual void PosixPaths(string name, string path, string length, string segment0, string segment1, string segment2, string segment3, string segment4, string segment5, string segment6, string anchor, string status, string normDepth, string[] exampleTags)
        {
