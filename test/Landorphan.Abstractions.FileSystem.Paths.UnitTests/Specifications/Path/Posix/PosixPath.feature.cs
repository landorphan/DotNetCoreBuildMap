...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Illegal Rel Astr", "./start-%03-end.txt", "2", "{.} .", "{G} start-%03-end.txt", "{N} (null)", "{N} (null)", "{N} (null)", "{N} (null)", "{N} (null)", "Relative", "Legal", "true", "1", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("Space Ending", "./test.txt%20", "2", "{.} .", "{G} test.txt%20", "{N} (null)", "{N} (null)", "{N} (null)", "{N} (null)", "{N} (null)", "Relative", "Legal", "true", "1", null)]
        [NUnit.Framework.TestCaseAttribute("Space Both", "./%20t.txt%20", "2", "{.} .", "{G} %20t.txt%20", "{N} (null)", "{N} (null)", "{N} (null)", "{N} (null)", "{N} (null)", "Relative", "Legal", "true", "1", null)]
