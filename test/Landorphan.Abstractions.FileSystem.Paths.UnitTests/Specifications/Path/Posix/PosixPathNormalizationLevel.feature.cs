...
namespace Landorphan.Abstractions.FileSystem.Paths.UnitTests.Specifications.Path.Posix
{
    ...
    [NUnit.Framework.DescriptionAttribute("Posix Path Normalization Level")]
    [NUnit.Framework.CategoryAttribute("Check-In")]
    public partial class PosixPathNormalizationLevelFeature
    {
...
#line 1 "PosixPathNormalizationLevel.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Posix Path Normalization Level", "\tIn order to develop a reliable Windows Path parser \r\n\tAs a member of the Landorp" +
        ...
        [NUnit.Framework.TestCaseAttribute("C:./file.txt", "Fully", "This is a Posix path so the \'.\' is not a self reference but part of the name ... " +
            "thus Fully", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("a/b/./c/../d/../../e", "NotNormalized", "To many resons to mention", null)]
        public virtual void PosixPathsCanBeNormalizedToBestAvailableForm_(string path, string normalizationLevel, string notes, string[] exampleTags)
        {
