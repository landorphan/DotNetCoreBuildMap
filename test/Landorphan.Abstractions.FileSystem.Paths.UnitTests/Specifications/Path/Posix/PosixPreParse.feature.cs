...
namespace Landorphan.Abstractions.FileSystem.Paths.UnitTests.Specifications.Path.Posix
{
    ...
    [NUnit.Framework.DescriptionAttribute("Posix Preparse")]
    [NUnit.Framework.CategoryAttribute("Check-In")]
    public partial class PosixPreparseFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Posix Preparse", "\tIn order to develop a reliable Windows Path parser \r\n\tAs a member of the Landorp" +
...
#line hidden
#line 9
  testRunner.When("I preparse the path as a Posix style path", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
