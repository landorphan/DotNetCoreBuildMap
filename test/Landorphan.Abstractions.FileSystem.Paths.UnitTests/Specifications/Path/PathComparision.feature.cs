...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Path Comparison", "\tIn order to work with paths\r\n\tAs a developer\r\n\tI need to be able to compare two " +
        ...
        [NUnit.Framework.DescriptionAttribute("Comare two paths for equivilance")]
        [NUnit.Framework.TestCaseAttribute("Linux", "/", "/", "equal to", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Linux", "/a", "/b", "less than", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Linux", "/b", "/a", "greater than", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Linux", "/a", "/a", "equal to", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Linux", "/A", "/a", "less than", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Linux", "/a", "/A", "greater than", "Default", null)]
        ...
        [NUnit.Framework.TestCaseAttribute("Linux", "/A", "/a", "equal to", "Insensitive", null)]
        [NUnit.Framework.TestCaseAttribute("Linux", "/a", "/A", "equal to", "Insensitive", null)]
        [NUnit.Framework.TestCaseAttribute("Windows", "/", "/", "equal to", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Windows", "/a", "/b", "less than", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Windows", "/b", "/a", "greater than", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Windows", "/a", "/a", "equal to", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Windows", "/A", "/a", "equal to", "Default", null)]
        [NUnit.Framework.TestCaseAttribute("Windows", "/a", "/A", "equal to", "Default", null)]
        ...
        public virtual void ComareTwoPathsForEquivilance(string oS, string path1, string path2, string compareType, string comparer, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Comare two paths for equivilance", null, tagsOfScenario, argumentsOfScenario);
#line 7
