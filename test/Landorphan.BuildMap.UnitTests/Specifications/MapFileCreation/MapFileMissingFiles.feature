@Check-In
Feature: Map File Missing Files
...
Scenario: Build a Simple Project
	Given I locate the following project files:
	  ...
	  And the following projects contain the following references:
		# NOTE: This is actually not used because Project2 is missing on disk in this test.
	    | Project  | Reference |
	    | Project2 | Project1  |
	 ...
	 Then the map file should contain the following projects:
		...
		| -1    | 0    | Library | CSharp   | Project2 | Missing | Solution1 | 2  | Project2`Project2.csproj |              |
